package com.lmtri.sharespace.activity.profiletab.historypost;
...
import com.lmtri.sharespace.fragment.profile.historypost.HistoryHousingFragment;
import com.lmtri.sharespace.fragment.profile.historypost.HistoryShareHousingFragment;
...
public class HistoryPostActivity extends AppCompatActivity {
    ...
    private OnHousingListInteractionListener mHousingListInteractionListener = new OnHousingListInteractionListener() {
        ...
        public void onHousingListInteraction(Housing item) {
            Intent intent = new Intent(HistoryPostActivity.this, HousingDetailActivity.class);
    ...
    private OnShareHousingListInteractionListener mShareHousingListInteractionListener = new OnShareHousingListInteractionListener() {
        ...
        public void onShareHousingListInteraction(ShareHousing item) {
            Intent intent = new Intent(HistoryPostActivity.this, ShareHousingDetailActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedTab = getIntent().getIntExtra(Constants.SELECTED_TAB_INDEX_POSTED_SHARE_HOUSING, 0);

        mTabLayout = (TabLayout) findViewById(R.id.activity_history_post_tab_layout);
        ...
        mViewPager = (CustomViewPager) findViewById(R.id.activity_history_post_view_pager);
        mViewPager.setOffscreenPageLimit(1);

        mViewPagerAdapter = new ViewPagerAdapter(getSupportFragmentManager());

        Fragment fragment1 = HistoryHousingFragment.newInstance(1);
        ((HistoryHousingFragment) fragment1).setListener(mHousingListInteractionListener);
        mViewPagerAdapter.addFragment(fragment1);

        Fragment fragment2 = HistoryShareHousingFragment.newInstance(1);
        ((HistoryShareHousingFragment) fragment2).setListener(mShareHousingListInteractionListener);
