package com.lmtri.sharespace.activity.profiletab.historysave;
...
import com.lmtri.sharespace.fragment.profile.historysave.HistorySavedHousingFragment;
import com.lmtri.sharespace.fragment.profile.historysave.HistorySavedShareHousingFragment;
...
public class HistorySaveActivity extends AppCompatActivity {
    ...
    private OnHousingListInteractionListener mHousingListInteractionListener = new OnHousingListInteractionListener() {
        ...
        public void onHousingListInteraction(Housing item) {
            Intent intent = new Intent(HistorySaveActivity.this, HousingDetailActivity.class);
    ...
    private OnShareHousingListInteractionListener mShareHousingListInteractionListener = new OnShareHousingListInteractionListener() {
        ...
        public void onShareHousingListInteraction(ShareHousing item) {
            Intent intent = new Intent(HistorySaveActivity.this, ShareHousingDetailActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabLayout = (TabLayout) findViewById(R.id.activity_history_save_tab_layout);
        ...
        mViewPager = (CustomViewPager) findViewById(R.id.activity_history_save_view_pager);
        mViewPager.setOffscreenPageLimit(1);

        mViewPagerAdapter = new ViewPagerAdapter(getSupportFragmentManager());

        Fragment fragment1 = HistorySavedHousingFragment.newInstance(1);
        ((HistorySavedHousingFragment) fragment1).setListener(mHousingListInteractionListener);
        mViewPagerAdapter.addFragment(fragment1);

        Fragment fragment2 = HistorySavedShareHousingFragment.newInstance(1);
        ((HistorySavedShareHousingFragment) fragment2).setListener(mShareHousingListInteractionListener);
